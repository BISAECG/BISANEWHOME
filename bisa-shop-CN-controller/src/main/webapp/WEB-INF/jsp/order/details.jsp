...
<div class="con">
    <div class="container" style="background:rgba(255,255,255,1);box-shadow:3px 9px 9px rgba(239,239,239,1);">
        <div class="row">
            ...
            <div class="col-md-5 col-md-offset-1 mt-40">
                ...
                <form class="form-horizontal" >
                    <div class="form-group" style="margin-bottom: 0px;">
                        <label for="Address" class="col-sm-3 control-label spantitle text-left">详细地址:</label>
                        <div class="col-sm-5 mt-5">
                            <input type="email" class="form-control" id="Address" placeholder="">
                        </div>
                    </div>
                    <div class="form-group" style="margin-bottom: 0px;">
                        <label for="name" class="col-sm-3 control-label spantitle text-left">姓名:</label>
                        <div class="col-sm-5 mt-5">
                            <input type="text" class="form-control" id="name" placeholder="">
                        </div>
                    </div>
                    <div class="form-group" style="margin-bottom: 0px;">
                        <label for="phone" class="col-sm-3 control-label spantitle text-left">电话:</label>
                        <div class="col-sm-5 mt-5">
                            <input type="text" class="form-control" id="phone" placeholder="">
                        </div>
                    </div>
                    <div class="form-group" style="margin-bottom: 0px;">
                        <label for="phone" class="col-sm-3 control-label spantitle text-left">优惠码:</label>
                        <div class="col-sm-5 mt-5">
                            <input type="text" class="form-control" id="Offer" placeholder="">
                        </div>
                    </div>
                </form>
