        ...
        <div class="container pl-0 pr-0">
            ...
            <div class="topbar-info" id="J_userInfo">
                <shiro:guest>
                    ...
                    <%--注册,暂时没有设置跳转--%>
                    <%--<a rel="nofollow" class="link" href="${pageContext.request.contextPath}/web/call/reg">--%>
                        <%--<spring:message code="register" />--%>
                    <%--</a>--%>
                </shiro:guest>
                        ...
                        <div class="mainnav_list mainnav_list_w-mc" style="display: none;" id="solution">
                            <div class="mainnav_li">
                                <div class="mainnav_list_left">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<%=request.getContextPath()%>/solution">
            ...
            <ul class="bar-top">
                ...
                <li class="bar-sort bar-l-car"> <a href="<%=request.getContextPath() %>/web/call/toCart" class="bar-link">
                    <div class="bar-img">
                        ...
                        <%--<span class="bar-car hidden J_barLMum J_homeRightbarCarNum">0</span> --%>
                        </div>
                        <span style="left: 29px;top: -14px;" class="cart-mini-num J_cartNum layui-badge layui-bg-blue ml-5"></span>
                    <p class="bar-text" style="margin-top: 5px;">
                        <spring:message code="shopCar" />
                    </p>
                    <div class="pop"></div>
                </a> </li>
