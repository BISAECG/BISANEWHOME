                ...
                <form class="layui-form" action="">
                    ...
                    <div class="clear pd-15 bg-fafafa bor bor-col-e8ebf2">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="describe" id="describe" lay-verify="required" placeholder="请输入新闻内容描述"
                                       autocomplete="off"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block" style="width: 150px;">
                                <select name="internationalization" class="newstype" lay-verify="required" name="newstype">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <input type="radio" name="roofPlacement" value="0" title="不置顶" checked>
                            </div>
                        </div>
                    </div>
