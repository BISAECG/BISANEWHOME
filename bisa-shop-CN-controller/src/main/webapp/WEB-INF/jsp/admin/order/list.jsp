...
<body class="layui-layout-body">
    <div class="layui-layout">
		...
		<div class="clear print-box dis-n">
			<!--startprint-->
            ...
            switch(obj.event){
                case 'getCheckData':
                    ...
                    layer.open({
                    	  ...
                    	  area: ['800px', '600px'],
                    	  anim: 2,
                    	  content: ['/admin/order/print?order_num='+data[0].order_num, 'no'],
                    
                    	});
                    
                  /*   layer.open({
                        type: 1
                        ,content: ['/admin/order/print?order_num='+data[0].order_num, 'no']//iframe的url，no代表不显示滚动条
						,title :'打印发票'
						,area: ['500px', '300px']
						,offset: 'auto'
                        ,btn: ['打印']
