...
<div class="wrap clear" id="title-list">
    <div class="container-full pos-r center-block">
        ...
        <p style="position: absolute;left:40%;top: 34%;">
            <span class="f-30 pr-40"  style="color: #FFFFFF;">關注健康</span>
            <span class="f-30" style="background: #3592D0;color: #FFFFFF;">關注碧沙健康</span>
        </p>
        <p class="f-30"  style="color: #FFFFFF;position: absolute;left:42%;top: 50%;">給家人一個悉心的呵護</p>
    ...
    <div class="container pt-20 pb-20">
        <div class="row">
            <div class="col-md-6 seach">
                <span style="color: #010101;">關鍵詞:</span>
                <span><a>心電儀</a></span>
                <span><a>碧沙</a></span>
                <span><a>心肌梗塞</a></span>
                <span><a>心電圖</a></span>
                ...
                success: function (data) {
                    ...
                    $.each(data, function(i, item) {
                        ...
                        $(".main_div").append(
                                ...
                                '<span  style="margin-left: 40px;">閱讀量:</span><span class="col-888 news-quantity">'+item.read_quantity+'</span>'+
                                '</p>'+
                                '</div>'+
                                '</div>'
                        )
                    ...
                    $.get("/news/list?page=" + page + "&limit=" + 5 , function (data) {
                        ...
                        layui.each(data.datas, function (index,item) {  //遍曆後台傳過來的數據
                            ...
                            lis.push(
                                    ...
                                    '</div>'+
                                    '<div class="col-md-1">'+
                                    '<span class="cur-p pull-right">詳情></span>'+
                                    '</div>'+
                                    '</div>'+
                                    '</div>'+
                                    '</li>'//作爲元素塞進數組lis中
