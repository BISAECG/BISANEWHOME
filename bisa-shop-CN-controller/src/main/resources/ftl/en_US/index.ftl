...
<div class="con">
    ...
    <div class="container-fluid mt-20 mb-20">
        <div class="row  pos-r" >
            <img  class="img-responsive center-block" src="../resources/img/index/banner7.png">
            <img  src="../resources/img/index/banner7-1.png" alt="檢測到停搏自動通知聯系人" class="pos-a " style="left: 25%;top: 42%;">
            <img src="../resources/img/index/banner7-2.png" alt="雙擊app按鈕通知聯系人" class="pos-a " style="left: 20%;top: 63%;">
            <img src="../resources/img/index/banner7-3.png" alt="雙擊操作鍵通知聯系人" class="pos-a" style="left: 25%;top: 85%;">
            <img src="../resources/img/index/banner7-4.png" alt="一對一電話咨詢認證醫師" class="pos-a " style="right: 26%;top: 42%;">
            <img src="../resources/img/index/banner7-5.png" alt="15分鍾免費檢測報告服務" class="pos-a " style="right: 20%;top: 63%;">
            <img src="../resources/img/index/banner7-6.png" alt="專科認證醫師在線答疑" class="pos-a " style="right: 25%;top: 85%;">
        </div>
    </div>
