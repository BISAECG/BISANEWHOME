...
<div class="footer">
    <div style="background: #2B2B31;width: 100%;">
        <div class="container" style="margin-top: 20px;">
            <div class="row">
                <div class="col-md-2 mt-20">
                    ...
                    <div class="pull-left  text-center" id="7000B">
                        <ul style="color: #2556A7;">
                            <p class="f-14" >
                                <span class="t-nonehove" style="color: #FFF;">About Bisa</span>
                            </p>
                ...
                <div class="col-md-2 mt-20">
                    <!--健康咨詢-->
                    <div class="pull-left  text-center" id="6000B">
                        <ul style="color: #2556A7;">
                            <p>
                ...
                <div class="col-md-2 mt-20">
                    <!--<%&#45;&#45;購物指南&#45;&#45;%>-->
                    <div class="pull-left  text-center" id="5000B">
                        <ul style="color: #2556A7;">
                            <p>
                                <span class="t-nonehove" style="color: #FFF;">Shopping guide</span>
                            </p>
                ...
                <div class="col-md-2 mt-20">
                    ...
                    <div class="pull-left text-center">
                        <ul style="color: #2556A7;">
                            <p>
                                <span class="t-nonehove" style="color: #FFF;">Links</span>
                            </p>
                            <li class="pt-20" style="border-top: 2px solid #323137;box-shadow:0px 1px 0px 0px rgba(40,39,45,1);">
                ...
                <div class="col-md-2 mt-20">
                    ...
                    <div class="pull-left   text-center">
                        <ul style="color: #2556A7;">
                            <p class="text-center  f-w f-14" style="color: #FFF;">
                                Contact us
                            </p>
                            <li class=" pb-10  pt-20  f-12" style="border-top: 2px solid #323137;box-shadow:0px 1px 0px 0px
                            rgba(40,39,45,1);">
                            <#--公司名稱-->
                                <span class="col-8c8c8c">${company_name}</span>
                            </li>
                            <li class=" pb-10    f-12" >
                            <#--公司地址-->
                                <span class="col-8c8c8c">${company_address}</span>
                            </li>
                            <li class=" pb-10    f-12" >
                                <span class="col-8c8c8c">E-mail: bisapecg@bisa.com.hk</span>
                            </li>
                            <li class=" pb-10    f-12" >
                            <#--公司電話-->
                                <span class="col-8c8c8c">Phone:${company_phone}</span>
                            </li>
                            <li class=" pb-10    f-12" >
                                <span class="col-8c8c8c"> Office hours:Monday to Friday 9:30–18:00</span>
                            </li>
                        </ul>
                ...
                <div class="col-md-2 mt-20">
                    <!--<%&#45;&#45;使用說明&#45;&#45;%>-->
                    <div class="pull-right  text-center" id="4000B">
                        <ul style="color: #2556A7;">
                            <p>
                                <span class="t-nonehove" style="color: #FFF;">Instructions for use</span>
                            </p>
                            <li class="pt-20" style="border-top: 2px solid #323137;box-shadow:0px 1px 0px 0px rgba(40,39,45,1);">
                                <a class="col-8c8c8c t-nonehove hovecol-309DE2 f-12"
                                   href="Instructions.html">
                                    Heart-to-heat ECG APP</a>
                            </li>
                            <li class="pt-20">
