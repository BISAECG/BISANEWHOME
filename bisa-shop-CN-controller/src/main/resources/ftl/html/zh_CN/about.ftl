...
<div class="wrap">
    <div class="clear full-ws">
        <img class="full-w" src="../resources/img/HK_About/banner.jpg" alt="关于碧沙">
        <p class="full-w-p">关于碧沙</p>
        <p class="full-w-p-1">关注健康 关注碧沙健康 给家一个悉心的呵护</p>
    ...
    <div class="clear container pl-0 pr-0 pl-100 pr-100 pb-100 pt-60">
        <p class="f-40 col-252525 h-70 line-h-70">
            BISA<span class="col-252525 ml-20 mr-20 pos-r t--2">|</span>关于碧沙
        </p>
        <p class="f-34 col-252525 pl-50 mt-20 mb-20 h-40 line-h-40 eng-h">
            碧沙专注于为每一个家庭带来便捷的健康服务。
        </p>
            ...
            <div class="clear col-sm-6 pl-25 pr-25">
                <div class="clear pt-20 bor bor-t bor-col-dcdcdc">
                    <p class="col-8c918c f-18 text-ind line-h-30">
                        深圳市碧沙科技有限公司是一家致力于大数据、医疗器械研发、制造与销售的高科技企业。2006年由香港宝荣集团（BIS Group）投资创建。原致力于研发石油， 油田自动化设备及物联网相关的有源RFID产品。从2014年开始，公司开始着力于大数据医疗器械的研发。2016年成功研制微型3导联动态心电图机并于香港某著名大学大数据中心成功合作设计与实现了心电图机与云计算平台的通讯协议。2017年成功转型集医疗仪器的研发、生产、销售为一体的民营高科技企业。
                    </p>
                    <p class="col-8c918c f-18 text-ind line-h-30">
                        目前，公司大力投入新产品的开发，努力在大数据分析算法和研制具有世界先进水平的医疗仪器产品方面有所突破。力争在短期内，成为同行业中，最具实力的企业之一。
                    </p>
                </div>
            </div>
            <div class="clear col-sm-6 pl-25 pr-25">
                <img class="full-w" src="../resources/img/HK_About/About-rightv1.png" alt="关于碧沙">
            </div>
        </div>
                    ...
                    <div class="clear full-w mgt">
                        ...
                        <div class="col-sm-9 pl-5 pr-0 pos-r">
                            ...
                            <p class="col-aaa f-18 line-h-25 h-25 mt-20 mb-5 ft-r">
                                让客户获得优质的服务。让股东获得持续的收益。让员工获得事业的成就。
                            </p>
