                	...
                	<#list empList as item>
						 ...
						 <#if (item_index == 0)>
		                    <li class='col-309DE2 pull-left ml-20 headList'>
		                        <a class='navlist pos-r ' href="javascript:void(0);">新闻资讯 </a>
		                        <ul class="pos-a">
		                            <li>
		                                <a class='navlist' href='news.html'>碧沙新闻</a>
		                            </li>
		                            <li>
		                                <a class="navlist" href='qa.html'>健康问答</a></li>
		                        </ul>
		                    </li>
						 </#if>
		...
		$.ajax({
            ...
            success: function (data) {
            	if(data.code=="0"){
            	    ...
            	    $(".loginDiv").html("<a class='pull-left' href='/login?lang=zh_CN'>登录</a>"+
                      "<sapn class='pull-left navDivision'></sapn>"+
                      "<a class='pull-left navReg'  href='/login?lang=zh_CN'>注册</a>");
            	}
