            ...
            <div class="row boxTop"  >
                <div class="col-md-2 mt-20">
                    ...
                    <div class="pull-left  text-left" id="7000B">
                        <ul>
                            <p class="f-14" >
                                <span class="t-nonehove" >關於碧沙</span>
                            </p>
                            <li class="pt-20" >
                ...
                <div class="col-md-2 mt-20">
                    ...
                    <div class="pull-left  text-left" id="6000B">
                        <ul>
                            <p>
                                <span class="t-nonehove" >健康資訊</span>
                            </p>
                            <li class="pt-20" >
                ...
                <div class="col-md-2 mt-20">
                    ...
                    <div class="pull-left  text-left" id="5000B">
                        <ul>
                            <p>
                                <span class="t-nonehove" >購物指南</span>
                            </p>
                ...
                <div class="col-md-2 mt-20">
                    ...
                    <div class="pull-left text-left">
                        <ul>
                            <p>
                                <span class="t-nonehove" >友情鏈接</span>
                            </p>
                            <li class="pt-20" >
                ...
                <div class="col-md-2 mt-20">
                    ...
                    <div class="pull-left   text-left">
                        <ul>
                            <p>
                                <span class="t-nonehove" >聯系我們</span>
                            </p>
                            ...
                            <li class=" pb-10    f-12" >
                                <span class="col-8c8c8c">電郵: bisapecg@bisa.com.hk</span>
                            </li>
                            <li class=" pb-10    f-12" >
                                <span class="col-8c8c8c">電話:${company_phone}</span>
                            </li>
                            <li class=" pb-10    f-12" >
                                <span class="col-8c8c8c"> 辦公時間:週壹至週五 9:30–18:00</span>
                            </li>
                        </ul>
                ...
                <div class="col-md-2 mt-20">
                    ...
                    <div class="pull-right  text-left" id="4000B">
                        <ul>
                            <p>
                                <span class="t-nonehove" >使用說明</span>
                            </p>
                            <li class="pt-20">
