        ...
        <div class="row">
            <div class="col-md-12" >
                ...
                <div class=" col-md-6">
                    ...
                    <p class="download-descrip"> 讓妳足不出戶測心電</p>
                    ...
                    <div class="download-ios  pull-left text-center" style=" width:200px;height:35px;">
                        <span><i class="fa fa-apple" aria-hidden="true" style="margin: 0 10PX; "></i>ios版下載</span>
                    </div>
                    <div class="download-android pull-left col-md-offset-1 text-center" style=" width:200px;height:35px;">
                        <span><i class="fa fa-android" aria-hidden="true" style="margin: 0 10PX; "></i>android版下載</span>
                    </div>
                    </p>
                </div>
            </div>
