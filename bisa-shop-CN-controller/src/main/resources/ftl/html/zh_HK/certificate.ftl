    ...
    <div class="container mt-40">
        <div class="row">
            <div class="col-md-4  col-md-offset-4 text-center">
                <img src="/resources/img/certificate/chanpintitle-hk.png" class="center-block ">
            </div>
        </div>
    </div>
    <div class="container mt-40">
        <div class="row">
            <div class="col-md-4" style="background: url('/resources/img/certificate/background.png') round;">
                <a href="/resources/img/certificate/SCZ.png" target="_blank">
                    <img src="/resources/img/index/chanpin.png"  class="center-block mt-20"  alt="醫療器械生產許可證">
            ...
            <div class="col-md-4"
                ...
                <a href="/resources/img/certificate/zcz.png" target="_blank">
                    <img src="/resources/img/index/chanpin1.png" class="center-block mt-20" alt="CFDA註冊證">
                    <p class="text-center  mt-5 mb-20">
                        CFDA註冊證
                    </p>
                </a>
