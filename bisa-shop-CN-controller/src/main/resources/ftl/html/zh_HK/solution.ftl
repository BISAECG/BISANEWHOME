    ...
    <div class="container">
        <div class="row mb-40">
            <div class="col-md-6 mt-40"  style="">
                <p class="" style="margin-bottom: 20px;color:rgba(255,255,255,1);font-size:24px;font-weight:400;margin-top: 5%;">醫院智慧心電監測技術解決方案</p>
                <p style="display: inline-block;width:32px;height:6px;background:rgba(108,99,255,1);margin-bottom: 36px;"></p>
                <p
                        style="color:rgba(243,242,242,1);font-size:16px;line-height: 24px;">針對目前醫療機構動態心電監測使用的傳統12導聯Holter存在的產品價格昂貴、患者佩戴不便、監測易受幹擾、僅能存儲24
                    小時數據、人工分析勞動量大、器材損耗大等問題，碧沙康健推出了智慧心電監測技術解決方案，實現長時段監測、AI智能分析、網上診療和緊急求助等應用，助力AI醫用技術的快速發展。</p>
                <p >
                    <a target="_blank" href=https://item.taobao.com/item.htm?spm=a230r.7195193.1997079397.10.7e1d114bDxBwby&id=605194973158&abbucket=9" class="text-center taobao1">淘寶商城</a>
                    <a target="_blank" href="https://item.jd.com/58928187146.html"  class="text-center jingdong1">京東自營</a>
                </p>
            </div>
...
<div class="container-fluid">
    ...
    <div class="row mb-40 pos-r">
        ...
        <div style="left: 52%;top: 56%;width:15%;" class="Advantage">
            利用碧沙智慧心電監測分析系統在雲端進行心電大數據處理並進行自動分析，無需人工分析，減少醫師大工作量勞動。即提高醫師工作效率，又提升診斷的準確性。
        </div>
        <div style="left: 72%;top: 56%;width:15%;" class="Advantage">
