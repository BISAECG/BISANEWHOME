    ...
    <div class="container">
        <div class="row mb-40">
            <div class="col-md-6 mt-40"  style="">
                <p class="" style="color:rgba(255,255,255,1);font-size:24px;font-weight:400;margin-top: 5%;">醫院智慧心電監測技術解決方案</p>
                <p style="display: inline-block;width:32px;height:6px;background:rgba(108,99,255,1);"></p>
                <p style="color:rgba(243,242,242,1);font-size:16px;">針對目前醫療機構動態心電監測使用的傳統12導聯Holter存在的產品價格昂貴、患者佩戴不便、監測易受幹擾、僅能存儲24
                    小時數據、人工分析勞動量大、器材損耗大等問題，碧沙康健推出了智慧心電監測技術解決方案，實現長時段監測、AI智能分析、網上診療和緊急求助等應用，助力AI醫用技術的快速發展。</p>
                <p >
...
<div class="container-fluid">
    ...
    <div class="row mb-40 pos-r">
        ...
        <div style="position: absolute;left: 12%;top: 54%;width:15%;" class="Advantage">
            碧沙心電儀使用簡單，無需導聯線，方便佩戴。除劇烈運動外，患者正常的日常活動不會影響心電監測。患者可自助使用或摘除心電儀，醫師可以根據患者制定長時段監測方案。
        </div>
        <div style="position: absolute;left: 32%;top: 54%;width:15%;" class="Advantage">
            傳統的12導聯Holter價格昂貴，單個Holter的價格約10~20萬，在存放和租借給患者使用過程中產生的設備損耗非常大。而碧沙心電儀價格實惠，大大減少醫院器材成本。
        </div>
        <div style="position: absolute;left: 52%;top: 54%;width:15%;" class="Advantage">
            利用碧沙智慧心電監測分析系統在雲端進行心電大數據處理並進行自動分析，無需人工分析，減少醫師大工作量勞動。即提高醫師工作效率，又提升診斷的準確性。
        </div>
        <div style="position: absolute;left: 72%;top: 54%;width:15%;" class="Advantage">
    ...
    <div class="row  mb-40 " style="background: #F3F6FF;">
        ...
        <div style="border: 10px solid #E6ECFF;width: 16%;margin: 20px;float: left;">
            ...
            <div style="margin: 5px;">
                <p style="margin-bottom:4px;font-size:18px;font-weight:bold;color:rgba(51,51,51,1);line-height:40px;">一臺專業電腦</p>
                <p style="width:34px;height:8px;background:rgba(132,132,132,1);"></p>
                <p style="font-size:14px;font-weight:400;color:rgba(102,102,102,1);line-height:24px;min-height: 145px;">
