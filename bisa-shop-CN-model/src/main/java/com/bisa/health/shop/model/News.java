...
public class News  implements Serializable{
    ...
    public News(int id, int news_id, String news_title, String news_subhead, int read_quantity, String news_content, String img_url, Date release_time, String author, int news_classify_id, String news_keyWord, String news_describe, int news_roofPlacement, String html_description, String html_title) {
        this.id = id;
        this.news_id = news_id;
        this.news_title = news_title;
        this.news_subhead = news_subhead;
